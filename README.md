...
A summary is **user-reviewed**, not silently generated by a background model. The editor initially offers the clone's last reply. Use `/clone-handoff` first when you want a purpose-written draft.
